...
public class Main {
    public static void main(String[] args) {
        ...
        actions[0] = new Human("Boris", distance, height);

        distance = rand.nextInt(10);
        height = rand.nextInt(10);

        actions[1] = new Robot("R2D2", distance, height);

        distance = rand.nextInt(10);
        height = rand.nextInt(10);
        actions[2] = new Cat("Kisya", distance, height);
        ...
        for (int i = 0; i < actions.length; i++) {
            ...
            if (result) {
                ...
                System.out.println("Unseccesfully!!");
            }
        }
    }
}
